...
╚════════════════════════════════════╝"
 Incorrect       = "Oops, an incorrect value,"
    ...
    NewV2           = "Your Spotify version ({0}) has not been tested. The stable version for SimpleSpotify is {1}"
    ...
    Spicetify       = "Spicetify detected, it must be installed after SimpleSpotify, open recommended actions in FAQ ? [Y/N]"
    ...
    NoRestore       = "SimpleSpotify has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
