...
╚════════════════════════════════════╝"
    ...
    NewV2           = "La tua versione {0} di Spotify non è stata testata. La versione stabile per SimpleSpotify è {1}"
    ...
    Spicetify       = "Spicetify rilevato, deve essere installato dopo SimpleSpotify, aprire le azioni consigliate nelle FAQ ? [Y/N]"
    NoRestore       = "SimpleSpotify è già stato installato, xpui.bak non trovato. `nPer favore, disinstalla Spotify e riapri il file Install.bat"
